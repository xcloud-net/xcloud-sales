...
public class TencentCloudBlobProvider : BlobProviderBase, ITransientDependency
{
    ...
    public TencentCloudBlobProvider(IMyBlobFilePathCalculator myBlobFilePathCalculator)
    {
    ...
    {
        var blobName = this._myBlobFilePathCalculator.GetStorageKeyShardingPath(name);
        return blobName;
    }
